...
- (void)viewDidLoad {
    ...
    self.enterButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width*.1,CGRectGetMaxY(self.view.frame) - 65, self.view.frame.size.width*.8, 40)];
    // [self.enterButton setTintColor:[UIColor purpleColor]];
    
    [self.enterButton setTitle:@"悠悠记" forState:UIControlStateNormal];
    self.enterButton.titleLabel.font = [UIFont systemFontOfSize:20];
    [self.enterButton setTitleColor:[UIColor colorWithRed:147/256.0 green:27/256.0 blue:48/256.0 alpha:1] forState:UIControlStateNormal];
    ...
    self.enterButton.layer.borderWidth =.5;
