...
- (void)setUpPopup {
    ...
    self.contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.maskView.frame.size.width, self.maskView.frame.size.height)];
    ...
    if (self.popupTitle) {
        ...
        title.font = [UIFont fontWithName:@"Menlo" size:15];
