...
CGFloat const YALTabBarViewDefaultHeight = 50.f;
CGFloat const YALExtraTabBarItemsDefaultHeight = 27.f;
CGFloat const YALForExtraTabBarItemsDefaultOffset = 15.f;
UIEdgeInsets const YALTabBarViewHDefaultEdgeInsets = {5.f, 7.f, 5.f, 7.f};
